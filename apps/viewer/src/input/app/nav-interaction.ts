...
class NavInteraction {
    ...
    private _onPointerDown = (event: PointerEvent) => {
        ...
        // Manual double-click/tap detection. In this experience a double-click
        // does nothing: it used to switch into fly mode and navigate there,
        // which felt broken. We still detect it so the second click can be
        // suppressed (no double-walk, no fly) — we just don't fire 'dblclick'.
        const now = Date.now();
